...
def menu():
    ...
    directories = ['/uploads/', '/upload/', '/files/', '/resume/', '/resumes/', '/documents/', '/docs/', '/pictures/',
                   '/file/', '/Upload/', '/Uploads/', '/Resume/', '/Resume/', '/UsersFiles/', '/Usersiles/',
                   '/usersFiles/',
                   '/Users_Files/', '/UploadedFiles/',
                   '/Uploaded_Files/', '/uploadedfiles/', '/uploadedFiles/', '/hpage/', '/admin/upload/',
                   '/admin/uploads/',
                   '/admin/resume/', '/admin/resumes/', '/admin/pictures/', '/pics/', '/photos/', '/Alumni_Photos/',
...
def banner():
    print("""\033[1;31m\033 
        This Tool Contains Certain Tool that hackers will use 
        Turn Any Machine Into Hacker's Machine Using This Tool
        Tool Is Created By Krisna Pranav
        Github Link https://www.github.com/krishpranav
        This tool works for any linux, android, mac
    \033[1;31m\033 """)
...
def menu():
   ...
   \033[39m\033[96m[2]Password Attacks
   \033[39m\033[96m[3]Wireless Testing
   \033[39m\033[96m[4]Exploitation Tools
   \033[39m\033[96m[5]Sniffing & Spoofing
   \033[39m\033[96m[6]Web Hacking
   \033[39m\033[96m[7]Private Web Hacking
   \033[39m\033[96m[8]Post Exploitation
   \033[39m\033[96m[99]Exit
 """)
...
def postexp():
    clearScr()
    banner()
    print("    \033[39m\033[96m[1]Shell Checker")
    print("        \033[39m\033[96m[2]POET")
    print("        \033[39m\033[96m[3]Phishing Framework \n")
...
def brutex():
    clearScr()
    print(
        "Automatically brute force all services running on a target : Open ports / DNS domains / Usernames / Passwords ")
...
def XSStrike():
    clearScr()
    print(
        "XSStrike is a python script designed to detect and exploit XSS vulnerabilites. Follow The Owner On Github @UltimateHackers")
    os.system("sudo rm -rf XSStrike")
    os.system(
        "git clone https://github.com/UltimateHackers/XSStrike.git && cd XSStrike && pip install -r requirements.txt && clear && python xsstrike")
...
def webhack():
    ...
    print("   \033[39m\033[96m[1]Drupal Hacking ")
    print("   \033[39m\033[96m[2]Inurlbr")
    print("   \033[39m\033[96m[3]Wordpress & Joomla Scanner")
    print("   \033[39m\033[96m[4]Gravity Form Scanner")
    print("   \033[39m\033[96m[5]File Upload Checker")
    print("   \033[39m\033[96m[6]Wordpress Exploit Scanner")
    print("   \033[39m\033[96m[7]Wordpress Plugins Scanner")
    print("   \033[39m\033[96m[8]Shell and Directory Finder")
    print("   \033[39m\033[96m[9]Joomla! 1.5 - 3.4.5 remote code execution")
    print("   \033[39m\033[96m[10]Vbulletin 5.X remote code execution")
    print(
        "   \033[39m\033[96m[11]BruteX - Automatically brute force all services running on a target")
    print("   \033[39m\033[96m[12]Arachni - Web Application Security Scanner Framework \n ")
    print("   \033[39m\033[96m[99]Back To Main Menu \n")
...
def setoolkit():
    ...
    print(" allow you to make a believable attack quickly.")
    print("")
...
def gravity():
    ...
    '\n'
    print
    '[*] Found, ', len(gravityforms), ' gravityforms.'
...
def info():
    ...
    print("  \033[39m\033[96m[1]Nmap ")
    print("  \033[39m\033[96m[2]Setoolkit")
    print("  \033[39m\033[96m[3]Port Scanning")
    print("  \033[39m\033[96m[4]Host To IP")
    print("  \033[39m\033[96m[5]wordpress user")
    print("  \033[39m\033[96m[6]CMS scanner")
    print("  \033[39m\033[96m[7]XSStrike")
    print("  \033[39m\033[96m[8]Dork - Google Dorks Passive Vulnerability Auditor ")
    print("  \033[39m\033[96m[9]Scan A server's Users  ")
    print("  \033[39m\033[96m[10]Crips\n  ")
    print("  \033[39m\033[96m[99]Back To Main Menu \n\n")
...
def passwd():
    ...
    print("    \033[39m\033[96m[1]Cupp ")
    print("    \033[39m\033[96m[2]Ncrack \n ")
...
def bluepot():
    print(
        "you need to have at least 1 bluetooh receiver (if you have many it will work wiht those, too). You must install / libbluetooth-dev on Ubuntu / bluez-libs-devel on Fedora/bluez-devel on openSUSE ")
...
def wire():
    ...
    print("    \033[39m\033[96m[1]reaver ")
    print("    \033[39m\033[96m[2]pixiewps")
    print("    \033[39m\033[96m[3]Bluetooth Honeypot GUI Framework")
    print("    \033[39m\033[96m[4]Fluxion\n")
    print("    \033[39m\033[96m[99]Back To The Main Menu \n\n")
...
def exp():
    ...
    print("    \033[39m\033[96m[1]ATSCAN")
    print("    \033[39m\033[96m[2]sqlmap")
    print("    \033[39m\033[96m[3]Shellnoob")
    print("    \033[39m\033[96m[4]commix")
    print("    \033[39m\033[96m[5]FTP Auto Bypass")
    print("    \033[39m\033[96m[6]jboss-autopwn")
    print("    \033[39m\033[96m[7]Blind SQL Automatic Injection And Exploit")
    print("    \033[39m\033[96m[8]Bruteforce the Android Passcode given the hash and salt")
    print("    \033[39m\033[96m[9]Joomla SQL injection Scanner \n ")
    print("    \033[39m\033[96m[99]Go Back To Main Menu \n\n")
...
def snif():
    ...
    print("   \033[39m\033[96m[1]Setoolkit ")
    print("   \033[39m\033[96m[2]SSLtrip")
    print("   \033[39m\033[96m[3]pyPISHER")
    print("   \033[39m\033[96m[4]SMTP Mailer \n ")
    print("   \033[39m\033[96m[99]Back To Main Menu \n\n")
...
menuu =   """
   \033[39m\033[96m[1]Get all websites
   \033[39m\033[96m[2]Get joomla websites
   \033[39m\033[96m[3]Get wordpress websites
   \033[39m\033[96m[4]Control Panel Finder
   \033[39m\033[96m[5]Zip Files Finder
   \033[39m\033[96m[6]Upload File Finder
   \033[39m\033[96m[7]Get server users
   \033[39m\033[96m[8]SQli Scanner
   \033[39m\033[96m[9]Ports Scan (range of ports)
   \033[39m\033[96m[10]ports Scan (common ports)
   \033[39m\033[96m[11]Get server Info
   \033[39m\033[96m[12]Bypass Cloudflare
   \033[39m\033[96m[99]Back To Main Menu
"""
...
class Fscan:
    ...
    def getWordpress(self):
        ...
        clearScr()
        print
        '[*] Found ', len(lista), ' Wordpress Website\n'
        for site in lista:
            print
            site
    ...
    def getJoomla(self):
        ...
        clearScr()
        print
        '[*] Found ', len(lista), ' Joomla Website\n'
        for site in lista:
            print
            site
...
def wppjmla():
    ...
    for ss in wordpress:
        ...
        ss
    print
    '[+] Found ! ', len(wordpress), ' Wordpress Websites'
    print
    '-' * 30 + '\n'
    for ss in joomla:
        print
    ...
    print
    '[+] Found ! ', len(joomla), ' Joomla Websites'
...
def wpminiscanner():
    ...
    for ss in wordpress:
        ...
        ss
    print
    '[*] Found, ', len(wordpress), ' wordpress sites.'
    print
    '-' * 30 + '\n'
    ...
    for ss in wpcontactcreativeform:
        ...
        ss
    print
    '[*] Found, ', len(wpcontactcreativeform), ' wp_contactcreativeform exploit.'
    print
    '-' * 30 + '\n'
    for ss in wplazyseoplugin:
        ...
        ss
    print
    '[*] Found, ', len(wplazyseoplugin), ' wp_lazyseoplugin exploit.'
    print
    '-' * 30 + '\n'
    for ss in wpeasyupload:
        ...
        ss
    print
    '[*] Found, ', len(wpeasyupload), ' wp_easyupload exploit.'
    print
    '-' * 30 + '\n'
    ...
    print
    '[*] Found, ', len(wpsymposium), ' wp_sympsiup exploit.'
